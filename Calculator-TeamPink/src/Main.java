            ...
            if (MortgagePayoffBiweeklyRepayment.isSelected()) {
                ...
                outputText = "<html>"
                     ...
                     + "This adjustment results in an interest savings of <b>"+currencyFormat.format(Double.parseDouble(results[4]))+"</b>." 
                        ...
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[5])) +"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[12]))+"</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>Total interest</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[6]))+"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[13]))+"</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>Remaining payments</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[7])) +"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[14])) +"</td>"
                        + "</tr>"
                        + "<td>Remaining interest</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[8])) +"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[15])) +"</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>Payoff in</td>"
                ...
                morgagePayoffRemainingBalance = mortgagePayoff[5];
                    ...
                    outputText = "<html>"
                     ...
                     + "This adjustment results in an interest savings of <b>"+currencyFormat.format(Double.parseDouble(results[7]))+"</b>." 
                        ...
                        + "<td>Total interest</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[14])) +"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[9]))+"</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>Remaining payments</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[15])) +"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[10])) +"</td>"
                        + "</tr>"
                        + "<td>Remaining interest</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[16]))+"</td>"
                        + "<td>"+currencyFormat.format(Double.parseDouble(results[11])) +"</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>Payoff in</td>"
                        + "<td>"+results[17]+ " </td>"
